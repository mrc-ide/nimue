...
vaccine_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("beta_set", "D_0", "E1_0", "E2_0", "gamma_E",
             ...
             "N_prioritisation_steps", "N_vaccine", "prob_death_multiplier",
             ...
             "rel_infectiousness_vaccinated", "S_0", "tt_beta", "tt_dur_R",
             "tt_hosp_beds", "tt_ICU_beds", "tt_matrix",
             "tt_prob_death_multiplier", "tt_prob_hosp_multiplier",
