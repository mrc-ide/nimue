...
deriv(S[,1]) <- 0 #  (gamma_R * R2[i,j]) - (lambda[i] * vaccine_efficacy_infection[i,j] * S[i,j]) - (vr * vaccination_target[i] * S[i,j])
deriv(S[,2]) <- 0 #  (vr * vaccination_target[i] * S[i,j-1]) + (gamma_R * R2[i,j]) - (lambda[i] * vaccine_efficacy_infection[i,j] * S[i,j]) - (gamma_vaccine[j] * S[i,j])
deriv(S[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * S[i,j-1]) + (gamma_R * R2[i,j]) - (lambda[i] * vaccine_efficacy_infection[i,j] * S[i,j]) - (gamma_vaccine[j] * S[i,j])
################################################################################
...
deriv(E1[,2]) <- 0 #  (vr * vaccination_target[i] * E1[i,j-1]) + (lambda[i] * vaccine_efficacy_infection[i,j] * S[i,j]) - (gamma_E * E1[i,j]) - (gamma_vaccine[j] * E1[i,j])
deriv(E1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * E1[i,j-1]) + (lambda[i] * vaccine_efficacy_infection[i,j] * S[i,j]) - (gamma_E * E1[i,j]) - (gamma_vaccine[j] * E1[i,j])

deriv(E2[,1]) <- 0 #  (gamma_E * E1[i,j]) - (gamma_E * E2[i,j]) - (vr * vaccination_target[i] * E2[i,j])
deriv(E2[,2]) <- 0 #  (vr * vaccination_target[i] * E2[i,j-1]) + (gamma_E * E1[i,j]) - (gamma_E * E2[i,j]) - (gamma_vaccine[j] * E2[i,j])
deriv(E2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * E2[i,j-1]) + (gamma_E * E1[i,j]) - (gamma_E * E2[i,j]) - (gamma_vaccine[j] * E2[i,j])
...
deriv(IMild[,1]) <- 0 #  (gamma_E * E2[i,j] * (1 - prob_hosp[i,j])) - (gamma_IMild * IMild[i,j])
deriv(IMild[,2]) <- 0 #  (gamma_E * E2[i,j] * (1 - prob_hosp[i,j])) - (gamma_IMild * IMild[i,j]) - (gamma_vaccine[j] * IMild[i,j])
deriv(IMild[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMild[i,j-1]) + (gamma_E * E2[i,j] * (1 - prob_hosp[i,j])) - (gamma_IMild * IMild[i,j]) - (gamma_vaccine[j] * IMild[i,j])
...
deriv(R1[,1]) <- 0 #  (gamma_rec * IRec2[i,j]) + (gamma_IMild * IMild[i,j]) + (gamma_get_ox_survive * IOxGetLive2[i,j]) + (gamma_not_get_ox_survive * IOxNotGetLive2[i,j]) + (gamma_not_get_mv_survive * IMVNotGetLive2[i,j]) - (gamma_R * R1[i,j]) - (vr * vaccination_target[i] * R1[i,j])
deriv(R1[,2]) <- 0 #  (vr * vaccination_target[i] * R1[i,j-1]) + (gamma_rec * IRec2[i,j]) + (gamma_IMild * IMild[i,j]) + (gamma_get_ox_survive * IOxGetLive2[i,j]) + (gamma_not_get_ox_survive * IOxNotGetLive2[i,j]) + (gamma_not_get_mv_survive * IMVNotGetLive2[i,j]) - (gamma_R * R1[i,j]) - (gamma_vaccine[j] * R1[i,j])
deriv(R1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * R1[i,j-1]) + (gamma_rec * IRec2[i,j]) + (gamma_IMild * IMild[i,j]) + (gamma_get_ox_survive * IOxGetLive2[i,j]) + (gamma_not_get_ox_survive * IOxNotGetLive2[i,j]) + (gamma_not_get_mv_survive * IMVNotGetLive2[i,j]) - (gamma_R * R1[i,j]) - (gamma_vaccine[j] * R1[i,j])

deriv(R2[,1]) <- 0 #  (gamma_R * R1[i,j]) - (gamma_R * R2[i,j]) - (vr * vaccination_target[i] * R2[i,j])
deriv(R2[,2]) <- 0 #  (vr * vaccination_target[i] * R2[i,j-1]) + (gamma_R * R1[i,j]) - (gamma_R * R2[i,j]) - (gamma_vaccine[j] * R2[i,j])
deriv(R2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * R2[i,j-1]) + (gamma_R * R1[i,j]) - (gamma_R * R2[i,j]) - (gamma_vaccine[j] * R2[i,j])
...
deriv(ICase1[,1]) <- 0 #  (gamma_E * E2[i,j] * prob_hosp[i,j]) - (gamma_ICase * ICase1[i,j])
deriv(ICase1[,2]) <- 0 #  (gamma_E * E2[i,j] * prob_hosp[i,j]) - (gamma_ICase * ICase1[i,j]) - (gamma_vaccine[j] * ICase1[i,j])
deriv(ICase1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * ICase1[i,j-1]) + (gamma_E * E2[i,j] * prob_hosp[i,j]) - (gamma_ICase * ICase1[i,j]) - (gamma_vaccine[j] * ICase1[i,j])

deriv(ICase2[,1]) <-  0 # (gamma_ICase * ICase1[i,j]) - (gamma_ICase * ICase2[i,j])
deriv(ICase2[,2]) <- 0 #  (gamma_ICase * ICase1[i,j]) - (gamma_ICase * ICase2[i,j]) - (gamma_vaccine[j] * ICase2[i,j])
deriv(ICase2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * ICase2[i,j-1]) + (gamma_ICase * ICase1[i,j]) - (gamma_ICase * ICase2[i,j]) - (gamma_vaccine[j] * ICase2[i,j])
...
deriv(IOxGetLive1[,1]) <- 0 #  ((1 - prob_non_severe_death_treatment[i]) * number_get_Ox[i,j]) - (gamma_get_ox_survive * IOxGetLive1[i,j])
deriv(IOxGetLive1[,2]) <- 0 #  ((1 - prob_non_severe_death_treatment[i]) * number_get_Ox[i,j]) - (gamma_get_ox_survive * IOxGetLive1[i,j]) - (gamma_vaccine[j] * IOxGetLive1[i,j])
deriv(IOxGetLive1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxGetLive1[i,j-1]) + ((1 - prob_non_severe_death_treatment[i]) * number_get_Ox[i,j]) - (gamma_get_ox_survive * IOxGetLive1[i,j]) - (gamma_vaccine[j] * IOxGetLive1[i,j])

deriv(IOxGetLive2[,1]) <- 0 #  (gamma_get_ox_survive * IOxGetLive1[i,j]) - (gamma_get_ox_survive * IOxGetLive2[i,j])
deriv(IOxGetLive2[,2]) <- 0 #  (gamma_get_ox_survive * IOxGetLive1[i,j]) - (gamma_get_ox_survive * IOxGetLive2[i,j]) - (gamma_vaccine[j] *  IOxGetLive2[i,j])
deriv(IOxGetLive2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] *  IOxGetLive2[i,j-1]) + (gamma_get_ox_survive * IOxGetLive1[i,j]) -  (gamma_get_ox_survive * IOxGetLive2[i,j]) - (gamma_vaccine[j] *  IOxGetLive2[i,j])
################################################################################
...
deriv(IOxGetDie1[,1]) <- 0 #  (prob_non_severe_death_treatment[i] * number_get_Ox[i,j]) - gamma_get_ox_die * IOxGetDie1[i,j]
deriv(IOxGetDie1[,2]) <- 0 #  (prob_non_severe_death_treatment[i] * number_get_Ox[i,j]) - gamma_get_ox_die * IOxGetDie1[i,j] - (gamma_vaccine[j] * IOxGetDie1[i,j])
deriv(IOxGetDie1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxGetDie1[i,j-1]) + (prob_non_severe_death_treatment[i] * number_get_Ox[i,j]) - gamma_get_ox_die * IOxGetDie1[i,j] - (gamma_vaccine[j] * IOxGetDie1[i,j])


deriv(IOxGetDie2[,]) <- 0 #  (gamma_get_ox_die * IOxGetDie1[i,j]) - (gamma_get_ox_die * IOxGetDie2[i,j])
deriv(IOxGetDie2[,2]) <- 0 #  (gamma_get_ox_die * IOxGetDie1[i,j]) - (gamma_get_ox_die * IOxGetDie2[i,j]) - (gamma_vaccine[j] * IOxGetDie2[i,j])
deriv(IOxGetDie2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxGetDie2[i,j-1]) + (gamma_get_ox_die * IOxGetDie1[i,j]) - (gamma_get_ox_die * IOxGetDie2[i,j]) - (gamma_vaccine[j] * IOxGetDie2[i,j])
################################################################################
...
deriv(IOxNotGetLive1[,1]) <- 0 #  ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * (1 - prob_non_severe_death_no_treatment[i])) - (gamma_not_get_ox_survive * IOxNotGetLive1[i,j])
deriv(IOxNotGetLive1[,2]) <- 0 #  ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * (1 - prob_non_severe_death_no_treatment[i])) - (gamma_not_get_ox_survive * IOxNotGetLive1[i,j]) - (gamma_vaccine[j] * IOxNotGetLive1[i,j])
deriv(IOxNotGetLive1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxNotGetLive1[i,j-1]) + ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * (1 - prob_non_severe_death_no_treatment[i])) - (gamma_not_get_ox_survive * IOxNotGetLive1[i,j]) - (gamma_vaccine[j] * IOxNotGetLive1[i,j])

deriv(IOxNotGetLive2[,1]) <- 0 #  (gamma_not_get_ox_survive * IOxNotGetLive1[i,j]) -  (gamma_not_get_ox_survive * IOxNotGetLive2[i,j])
deriv(IOxNotGetLive2[,2]) <- 0 #  (gamma_not_get_ox_survive * IOxNotGetLive1[i,j]) -  (gamma_not_get_ox_survive * IOxNotGetLive2[i,j]) - (gamma_vaccine[j] * IOxNotGetLive2[i,j])
deriv(IOxNotGetLive2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxNotGetLive2[i,j-1]) + (gamma_not_get_ox_survive * IOxNotGetLive1[i,j]) -  (gamma_not_get_ox_survive * IOxNotGetLive2[i,j]) - (gamma_vaccine[j] * IOxNotGetLive2[i,j])
################################################################################
...
deriv(IOxNotGetDie1[,1]) <- 0 #  ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * prob_non_severe_death_no_treatment[i]) - (gamma_not_get_ox_die * IOxNotGetDie1[i,j])
deriv(IOxNotGetDie1[,2]) <- 0 #  ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * prob_non_severe_death_no_treatment[i]) - (gamma_not_get_ox_die * IOxNotGetDie1[i,j]) - (gamma_vaccine[j] * IOxNotGetDie1[i,j])
deriv(IOxNotGetDie1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxNotGetDie1[i,j-1]) + ((number_requiring_Ox[i,j] - number_get_Ox[i,j]) * prob_non_severe_death_no_treatment[i]) - (gamma_not_get_ox_die * IOxNotGetDie1[i,j]) - (gamma_vaccine[j] * IOxNotGetDie1[i,j])

deriv(IOxNotGetDie2[,1]) <- 0 #  (gamma_not_get_ox_die * IOxNotGetDie1[i,j]) - (gamma_not_get_ox_die * IOxNotGetDie2[i,j])
deriv(IOxNotGetDie2[,2]) <- 0 #  (gamma_not_get_ox_die * IOxNotGetDie1[i,j]) - (gamma_not_get_ox_die * IOxNotGetDie2[i,j]) - (gamma_vaccine[j] * IOxNotGetDie2[i,j])
deriv(IOxNotGetDie2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IOxNotGetDie2[i,j-1]) + (gamma_not_get_ox_die * IOxNotGetDie1[i,j]) - (gamma_not_get_ox_die * IOxNotGetDie2[i,j]) - (gamma_vaccine[j] * IOxNotGetDie2[i,j])
################################################################################
...
deriv(IMVGetLive1[,1]) <- 0 #  ((1 - prob_severe_death_treatment[i]) * number_get_IMV[i,j]) - (gamma_get_mv_survive * IMVGetLive1[i,j])
deriv(IMVGetLive1[,2]) <-  0 # ((1 - prob_severe_death_treatment[i]) * number_get_IMV[i,j]) - (gamma_get_mv_survive * IMVGetLive1[i,j]) - (gamma_vaccine[j] * IMVGetLive1[i,j])
deriv(IMVGetLive1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVGetLive1[i,j-1]) + ((1 - prob_severe_death_treatment[i]) * number_get_IMV[i,j]) - (gamma_get_mv_survive * IMVGetLive1[i,j]) - (gamma_vaccine[j] * IMVGetLive1[i,j])

deriv(IMVGetLive2[,1]) <- 0 #  (gamma_get_mv_survive * IMVGetLive1[i,j]) - (gamma_get_mv_survive * IMVGetLive2[i,j])
deriv(IMVGetLive2[,2]) <- 0 #  (gamma_get_mv_survive * IMVGetLive1[i,j]) - (gamma_get_mv_survive * IMVGetLive2[i,j]) - (gamma_vaccine[j] * IMVGetLive2[i,j])
deriv(IMVGetLive2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVGetLive2[i,j-1]) + (gamma_get_mv_survive * IMVGetLive1[i,j]) - (gamma_get_mv_survive * IMVGetLive2[i,j]) - (gamma_vaccine[j] * IMVGetLive2[i,j])
################################################################################
...
deriv(IMVGetDie1[,1]) <- 0 #  (prob_severe_death_treatment[i] * number_get_IMV[i,j]) - (gamma_get_mv_die * IMVGetDie1[i,j])
deriv(IMVGetDie1[,2]) <- 0 #  (prob_severe_death_treatment[i] * number_get_IMV[i,j]) - (gamma_get_mv_die * IMVGetDie1[i,j]) - (gamma_vaccine[j] * IMVGetDie1[i,j])
deriv(IMVGetDie1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVGetDie1[i,j-1]) + (prob_severe_death_treatment[i] * number_get_IMV[i,j]) - (gamma_get_mv_die * IMVGetDie1[i,j]) - (gamma_vaccine[j] * IMVGetDie1[i,j])

deriv(IMVGetDie2[,1]) <- 0 #  (gamma_get_mv_die * IMVGetDie1[i,j]) - (gamma_get_mv_die * IMVGetDie2[i,j])
deriv(IMVGetDie2[,2]) <- 0 #  (gamma_get_mv_die * IMVGetDie1[i,j]) - (gamma_get_mv_die * IMVGetDie2[i,j]) - (gamma_vaccine[j] * IMVGetDie2[i,j])
deriv(IMVGetDie2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVGetDie2[i,j-1]) + (gamma_get_mv_die * IMVGetDie1[i,j]) - (gamma_get_mv_die * IMVGetDie2[i,j]) - (gamma_vaccine[j] * IMVGetDie2[i,j])
################################################################################
...
deriv(IMVNotGetLive1[,1]) <- 0 #  ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * (1 - prob_severe_death_no_treatment[i])) - (gamma_not_get_mv_survive * IMVNotGetLive1[i,j])
deriv(IMVNotGetLive1[,2]) <- 0 #  ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * (1 - prob_severe_death_no_treatment[i])) - (gamma_not_get_mv_survive * IMVNotGetLive1[i,j]) - (gamma_vaccine[j] * IMVNotGetLive1[i,j])
deriv(IMVNotGetLive1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVNotGetLive1[i,j-1]) + ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * (1 - prob_severe_death_no_treatment[i])) - (gamma_not_get_mv_survive * IMVNotGetLive1[i,j]) - (gamma_vaccine[j] * IMVNotGetLive1[i,j])

deriv(IMVNotGetLive2[,1]) <- 0 #  (gamma_not_get_mv_survive * IMVNotGetLive1[i,j]) - (gamma_not_get_mv_survive * IMVNotGetLive2[i,j])
deriv(IMVNotGetLive2[,2]) <- 0 #  (gamma_not_get_mv_survive * IMVNotGetLive1[i,j]) - (gamma_not_get_mv_survive * IMVNotGetLive2[i,j]) - (gamma_vaccine[j] * IMVNotGetLive2[i,j])
deriv(IMVNotGetLive2[,3:N_vaccine]) <-  0 # (gamma_vaccine[j-1] * IMVNotGetLive2[i,j-1]) + (gamma_not_get_mv_survive * IMVNotGetLive1[i,j]) - (gamma_not_get_mv_survive * IMVNotGetLive2[i,j]) - (gamma_vaccine[j] * IMVNotGetLive2[i,j])
################################################################################
...
deriv(IMVNotGetDie1[,1]) <- 0 #  ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * prob_severe_death_no_treatment[i]) - (gamma_not_get_mv_die * IMVNotGetDie1[i,j])
deriv(IMVNotGetDie1[,2]) <- 0 #  ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * prob_severe_death_no_treatment[i]) - (gamma_not_get_mv_die * IMVNotGetDie1[i,j]) - (gamma_vaccine[j] * IMVNotGetDie1[i,j])
deriv(IMVNotGetDie1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVNotGetDie1[i,j-1]) + ((number_requiring_IMV[i,j] - number_get_IMV[i,j]) * prob_severe_death_no_treatment[i]) - (gamma_not_get_mv_die * IMVNotGetDie1[i,j]) - (gamma_vaccine[j] * IMVNotGetDie1[i,j])

deriv(IMVNotGetDie2[,1]) <- 0 #  (gamma_not_get_mv_die * IMVNotGetDie1[i,j]) - (gamma_not_get_mv_die * IMVNotGetDie2[i,j])
deriv(IMVNotGetDie2[,2]) <- 0 #  (gamma_not_get_mv_die * IMVNotGetDie1[i,j]) - (gamma_not_get_mv_die * IMVNotGetDie2[i,j]) - (gamma_vaccine[j] * IMVNotGetDie2[i,j])
deriv(IMVNotGetDie2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IMVNotGetDie2[i,j-1]) + (gamma_not_get_mv_die * IMVNotGetDie1[i,j]) - (gamma_not_get_mv_die * IMVNotGetDie2[i,j]) - (gamma_vaccine[j] * IMVNotGetDie2[i,j])
################################################################################
...
deriv(IRec1[,1]) <- 0 #  (gamma_get_mv_survive * IMVGetLive2[i,j]) - (gamma_rec * IRec1[i,j])
deriv(IRec1[,2]) <- 0 #  (gamma_get_mv_survive * IMVGetLive2[i,j]) - (gamma_rec * IRec1[i,j]) - (gamma_vaccine[j] * IRec1[i,j])
deriv(IRec1[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IRec1[i,j-1]) + (gamma_get_mv_survive * IMVGetLive2[i,j]) - (gamma_rec * IRec1[i,j]) - (gamma_vaccine[j] * IRec1[i,j])

deriv(IRec2[,1]) <- 0 #  (gamma_rec * IRec1[i,j]) - (gamma_rec * IRec2[i,j])
deriv(IRec2[,2]) <- 0 #  (gamma_rec * IRec1[i,j]) - (gamma_rec * IRec2[i,j]) - (gamma_vaccine[j] * IRec2[i,j])
deriv(IRec2[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * IRec2[i,j-1]) + (gamma_rec * IRec1[i,j]) - (gamma_rec * IRec2[i,j]) - (gamma_vaccine[j] * IRec2[i,j])
...
deriv(D[,1]) <- 0 # (gamma_get_ox_die * IOxGetDie2[i,j]) + (gamma_not_get_ox_die * IOxNotGetDie2[i,j]) + (gamma_get_mv_die * IMVGetDie2[i,j]) + (gamma_not_get_mv_die * IMVNotGetDie2[i,j])
deriv(D[,2]) <- 0 #  (gamma_get_ox_die * IOxGetDie2[i,j]) + (gamma_not_get_ox_die * IOxNotGetDie2[i,j]) + (gamma_get_mv_die * IMVGetDie2[i,j]) + (gamma_not_get_mv_die * IMVNotGetDie2[i,j]) - (gamma_vaccine[j] * D[i,j])
deriv(D[,3:N_vaccine]) <- 0 #  (gamma_vaccine[j-1] * D[i,j-1]) + (gamma_get_ox_die * IOxGetDie2[i,j]) + (gamma_not_get_ox_die * IOxNotGetDie2[i,j]) + (gamma_get_mv_die * IMVGetDie2[i,j]) + (gamma_not_get_mv_die * IMVNotGetDie2[i,j]) - (gamma_vaccine[j] * D[i,j])
################################################################################
